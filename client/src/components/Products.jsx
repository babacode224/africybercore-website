...
const Products = () => {
  ...
  },
  {
    ...
    url: "https://afriagrocore.solutions",
    description:
              ...
              >
                ...
                <div className="px-8 pb-8">
                  <div className="flex space-x-3">
                    {product.url ? (
                      <a href={product.url} target="_blank" rel="noopener noreferrer" className="text-white bg-primary text-sm font-semibold px-4 py-2 rounded-lg flex-1 text-center hover:bg-primary/90 transition-colors">
                        Visit Platform
                      </a>
                    ) : (
                      <a href='#consulting' className="text-white bg-primary text-sm font-semibold px-4 py-2 rounded-lg flex-1 text-center hover:bg-primary/90 transition-colors">
                        Contact Sales
                      </a>
                    )}
                  </div>
