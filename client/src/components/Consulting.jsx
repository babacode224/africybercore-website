...
const Consulting = () => {
  ...
  // Map service IDs to interest options
  const serviceToInterest = {
    'frontend-web': 'Software Development',
    'fullstack-website': 'Software Development',
    'web-app-standard': 'Software Development',
    'web-app-advanced': 'Software Development',
    'mobile-app': 'Software Development',
    'hybrid-ecosystem': 'Software Development',
  ...
  useEffect(() => {
    ...
    if (service && serviceToInterest[service]) {
      setFormData(prev => ({
        ...prev,
        interest: serviceToInterest[service]
      }));
    }
  }, [location]);

  useEffect(() => {
    // Check if service is in localStorage (from rate card click)
    const selectedService = localStorage.getItem('selectedService');
    if (selectedService && serviceToInterest[selectedService]) {
      setFormData(prev => ({
        ...prev,
        interest: serviceToInterest[selectedService]
      }));
