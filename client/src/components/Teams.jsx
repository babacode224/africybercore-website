    ...
    {[
      {
        ...
        image: "/third.jpg",
        bio: "Professional cybersecurity expert driving digital resilience across Africa.",
      ...
      },
      {
        ...
        image: "/second.png",
        bio: "Specialist in IT infrastructure design and connectivity.",
        expertise: ["IT Infrastructure Expert"],
        linkedin: "#"
      },
      {
        ...
        expertise: ["AI No-Code & Business Automation Expert"],
        linkedin: "#"
      },
    ].map((member, idx) => (
      <div
