...
const FourPillars = () => {
  const pillars = [
    ...
    },
    {
      ...
      subtitle: 'The Engine',
      description: 'AI-powered CRM setups, Intelligent AI Chatbots, Zapier/Make workflows, and Auto-Invoicing.',
    ...
    },
    {
      ...
      subtitle: 'The Future',
      description: 'Corporate workshops and individual bootcamps on No-Code, AI tools, and AI-powered automation.',
